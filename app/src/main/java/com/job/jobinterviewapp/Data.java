...
public class Data {
    ...
    @SerializedName("video_genres")
    @Expose
    private List<VideoGenre> videoGenres = null;
    @SerializedName("video_tags")
    @Expose
    private List<VideoTag> videoTags = null;
    @SerializedName("category_season")
    @Expose
    private Object categorySeason;
    @SerializedName("video_artists")
    @Expose
    private List<VideoArtist> videoArtists = null;
    @SerializedName("video_comments")
    @Expose
    private List<Object> videoComments = null;
    @SerializedName("video_subtitles")
    @Expose
    private List<Object> videoSubtitles = null;
    @SerializedName("video_zones")
    @Expose
    private List<VideoZone> videoZones = null;
    ...
    public Object getTitleBng() {
        return titleBng;
    }

    public void setTitleBng(Object titleBng) {
    ...
    public Object getDescriptionBng() {
        return descriptionBng;
    }

    public void setDescriptionBng(Object descriptionBng) {
    ...
    public void setPreviewTrailer(String previewTrailer) {
    ...
    public Object getCategorySeason() {
        return categorySeason;
    }

    public void setCategorySeason(Object categorySeason) {
        this.categorySeason = categorySeason;
    }

    public List<VideoArtist> getVideoArtists() {
        return videoArtists;
    }

    public void setVideoArtists(List<VideoArtist> videoArtists) {
    ...
    public List<Object> getVideoSubtitles() {
        return videoSubtitles;
    }

    public void setVideoSubtitles(List<Object> videoSubtitles) {
        this.videoSubtitles = videoSubtitles;
    }

    public List<VideoZone> getVideoZones() {
        return videoZones;
    }

    public void setVideoZones(List<VideoZone> videoZones) {
